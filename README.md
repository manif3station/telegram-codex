...
`dashboard telegram-codex.start --version` is a pure metadata query that prints only the raw skill semver line DD expects. DD can probe it safely without creating or restarting collectors.
