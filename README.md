...
When the mapped session is already live in a tmux-backed Codex TUI, the worker prefers live pane injection and transcript tailing before it falls back to detached resume.
